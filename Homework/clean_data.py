...
# 3. All First Names Should Be written in Capital Letters [Dimash OMAR]
#   3.a  If name is null replace it by writing False
...
# 3. Все имена должны быть написаны заглавными буквами [Димаш ОМАР]
